module.exports = class {
  ...
  async run(member) {
    ...
    member.guild.channels.find("name", settings.welcomeChannel).send(`${this.client.responses.goodbyeMessages.random().replaceAll("{{user}}", member.user.username).trim()}`).catch(console.error);
  }
};
