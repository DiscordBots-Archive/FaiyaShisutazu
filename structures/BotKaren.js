...
class KarenClient extends Client {
  constructor(options) {
    super(options);
    this.config = require("../config.js");
    this.console = new BotConsole(this);
    this.responses = require(`../assets/languages/${this.config.defaultSettings.language}/Karen/responses.js`);
  ...
  async init() {
    ...
    this.console.log(`Karen loaded a total of ${commands} commands.`);
    this.console.log(`Karen loaded a total of ${events} events.`);
