...
class Tsukihi extends Client {
  constructor(options) {
    super(options);
    this.config = require("../config.js");
    this.console = new BotConsole(this);
    this.responses = require("../assets/responses/tsukihi.js");
  ...
  async init() {
    ...
    this.console.log(`Tsukihi loaded a total of ${commands} commands & ${events} events.`);
